...
USER=root
USER_GROUP=root
IMAGE_NAME=xpanda/envoy-build-centos
IMAGE_ID=v1.13.0
#IMAGE_ID=81fef4532b8432ee82368d7575e6275bf97993e628583e61ae33f8e5ef5d60fb
[[ -z "${IMAGE_NAME}" ]] && IMAGE_NAME="envoyproxy/envoy-build-centos@sha256"
...
docker run -d ${DOCKER_TTY_OPTION} -e HTTP_PROXY=${http_proxy} -e HTTPS_PROXY=${https_proxy} \
  ...
  --cap-add SYS_PTRACE --cap-add NET_RAW --cap-add NET_ADMIN "${ENVOY_BUILD_IMAGE}"
